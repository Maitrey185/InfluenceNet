...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInfluencerNotFoundException(InfluencerNotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleSocialAccountNotFoundException(SocialAccountNotFoundException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.NOT_FOUND.value(),
                ex.getMessage(),
                LocalDateTime.now()
